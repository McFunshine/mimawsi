...
/**
 * A temporary directory that is really outside the project. Duplicated from
 * packages/adapters-fake/src/temp-root.ts on purpose: nothing in packages/ may
 * import from tests/, and a shared package is not worth it for this.
 *
